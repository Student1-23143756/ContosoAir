[![Build Status](https://dev.azure.com/Mikesazuretest/GitHub%20Integration/_apis/build/status/Student1-23143756.ContosoAir?branchName=master)](https://dev.azure.com/Mikesazuretest/GitHub%20Integration/_build/latest?definitionId=3&branchName=master)# This project is retired, archived, and no longer supported. You are welcome to continue to use and fork the repository.
